...
#define ANSI_COLOR_BACK_BLUE  "\033[37;44m"
#define ANSI_COLOR_BACK_RED   "\033[37;41m"
#define ANSI_COLOR_BACK_GREEN "\033[37;42m"
...
int main(int argc, char ** argv)
{
  ...
  std::cout << ANSI_COLOR_BACK_BLUE "This text is backgroud blue." ANSI_COLOR_RESET << std::endl;
  std::cout << ANSI_COLOR_BACK_RED "This text is backgroud red." ANSI_COLOR_RESET << std::endl;
  std::cout << ANSI_COLOR_BACK_GREEN "This text is backgroud green." ANSI_COLOR_RESET << std::endl;
